...
4. Extend the index loader only after each referenced typed document surface
   ...
   and model runtimes, while evidence-bearing/qualified profiles, other profile
   kinds, and recommendations fail closed.
